...
from archs.dagf.models.utils.ops import unpixel_shuffle
from archs.dagf.models.utils.tupperware import tupperware

from archs.dagf.models.lr_net import SmoothDilatedResidualAtrousGuidedBlock, LRNet
from archs.dagf.models.model_utils import AdaptiveInstanceNorm

from sacred import Experiment
from archs.dagf.config import initialise
...
class DeepAtrousGuidedFilter(nn.Module):
    def __init__(self, args=None, radius=1):
        super().__init__()
    ...
    def forward(self, x_hr):
        ...
        out = F.tanh(self.gf(self.guided_map(x_lr), y_lr, self.guided_map(x_hr)))
        return out
