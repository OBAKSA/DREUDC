...
class ImageDataset_raw2rgb(Dataset):
    def __init__(self, image_dirs, panel_type):
        ...
        # udc_files : noisy image
        # clean_files : clean image
...
class ImageDataset_rgb(Dataset):
    def __init__(self, image_dirs, panel_type):
        # image_dirs : has HQ/LQ directory
        # udc_files : noisy image
        # clean_files : clean image
        ...
        if self.panel_type == 'axon':
            self.udc_files_dirs = image_dirs + 'rgb/test/axon/*.png'
        else:
            self.udc_files_dirs = image_dirs + 'rgb/test/zfold/*.png'
